...
import { getWebhook } from "service/api";
  ...
  function callApi2() {
    ...
    getWebhook(req)
      .then((res) => {
        ...
        localStorage.setItem("sd", JSON.stringify(res?.err));

        localStorage.setItem("ecode", JSON.stringify(res?.ECODE));
          ...
          <Column className="bg-gray_800 items-center justify-end w-[100%]">
            <Row className="items-start justify-start lg:mt-[37px] xl:mt-[42px] 2xl:mt-[48px] 3xl:mt-[57px] mt-[64px] 2xl:mx-[108px] 3xl:mx-[129px] mx-[144px] lg:mx-[84px] xl:mx-[96px] w-[80%]">
              <Column className="items-start justify-start lg:mb-[15px] xl:mb-[17px] 2xl:mb-[19px] 3xl:mb-[23px] mb-[26px] w-[28%]">
                ...
                <div className="2xl:ml-[18px] 2xl:my-[12px] 3xl:mb-[15px] 3xl:ml-[21px] 3xl:mt-[14px] bg-transparent border-0 lg:ml-[14px] lg:my-[9px] mb-[17px] ml-[24px] mt-[16px] w-[91%] xl:mb-[11px] xl:ml-[16px] xl:mt-[10px] input-wrap">
                  <Image
                    src={"images/img_arrow_1.svg"}
                    className="absolute right-[16px] bg-transparent border-0 lg:right-[9px] xl:right-[10px] 2xl:right-[12px] 3xl:right-[14px] my-[auto] inset-y-[0]"
                    alt="Arrow"
                  />
                  <Input
                    className="bg-white_A700 border-0 font-normal not-italic opacity-op5 lg:pr-[46px] xl:pr-[53px] 2xl:pr-[60px] 3xl:pr-[72px] pr-[80px] text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_500 tracking-ls1 w-[100%]"
                    name="Enteryouremai"
                    placeholder={""}
                  ></Input>
                </div>
