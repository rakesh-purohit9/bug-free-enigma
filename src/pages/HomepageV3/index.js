...
import { getView1 } from "service/api";
...
const HomepageV3Page = () => {
  ...
  const handleNavigate4 = () => navigate("/categorieswithsidebar");
  const handleNavigate1 = () =>
    navigate("/productdetails", { state: { qwe: appdata?.name } });
  function callApi1() {
    const req = {};
    getView1(req)
      .then((res) => {
            ...
            <Column className="items-center justify-start w-[100%]">
              <Row className="bg-white_A700 items-center justify-start w-[100%]">
                <Row className="items-center justify-center lg:mb-[20px] xl:mb-[23px] 2xl:mb-[26px] 3xl:mb-[31px] mb-[35px] 2xl:ml-[108px] 3xl:ml-[129px] ml-[144px] lg:ml-[84px] xl:ml-[96px] lg:mt-[19px] xl:mt-[22px] 2xl:mt-[25px] 3xl:mt-[30px] mt-[34px] w-[28%]">
                  ...
                  <Text
                    className="common-pointer cursor-pointer hover:font-bold font-normal lg:ml-[32px] xl:ml-[37px] 2xl:ml-[42px] 3xl:ml-[50px] ml-[56px] not-italic lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_800 text-left w-[auto]"
                ...
                <Image
                  ...
                  alt="Group19"
                />
                <Text className="cursor-pointer hover:font-bold font-bold lg:ml-[4px] xl:ml-[5px] 2xl:ml-[6px] 3xl:ml-[7px] ml-[8px] lg:my-[17px] xl:my-[20px] 2xl:my-[22px] 3xl:my-[27px] my-[30px] lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-gray_800 text-left w-[auto]">
                  {apiData1?.err}
                </Text>
                <Image
        ...
        <Stack className="lg:h-[419px] xl:h-[480px] 2xl:h-[539px] 3xl:h-[647px] h-[718px] w-[100%]">
          ...
          <Column className="absolute bg-white_A700_82 inset-[0] items-start justify-center xl:py-[104px] 2xl:py-[117px] 3xl:py-[141px] py-[157px] lg:py-[91px] w-[100%]">
            ...
            <Row className="bg-gray_800 font-poppins items-center justify-start lg:mt-[46px] xl:mt-[53px] 2xl:mt-[60px] 3xl:mt-[72px] mt-[80px] lg:mx-[165px] xl:mx-[188px] 2xl:mx-[212px] 3xl:mx-[254px] mx-[283px] w-[13%]">
              <Text className="font-medium lg:ml-[19px] xl:ml-[22px] 2xl:ml-[24px] 3xl:ml-[29px] ml-[33px] 3xl:my-[10px] my-[12px] lg:my-[7px] xl:my-[8px] 2xl:my-[9px] lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-left text-white_A700 w-[auto]">
                {apiData1?.ECODE}
              </Text>
              <Image
