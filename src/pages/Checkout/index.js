...
const CheckoutPage = () => {
  ...
  const handleNavigate7 = () => navigate("/completed");
                ...
                <Column className="items-center lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] w-[100%]">
                  ...
                  <Row className="items-center justify-between lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] w-[100%]">
                    <Column className="items-start w-[58%]">
                      ...
                      <div className="2xl:mt-[12px] 3xl:mt-[14px] bg-transparent lg:mt-[9px] mt-[16px] w-[100%] xl:mt-[10px] input-wrap">
                        <Image
                          src={"images/img_vector_1.svg"}
                          className="absolute right-[39.059998px] bg-transparent lg:right-[22px] xl:right-[26px] 2xl:right-[29px] 3xl:right-[35px] my-[auto] inset-y-[0]"
                          alt="Vector"
                        />
                        <SelectBox
                          className="bg-transparent border border-bluegray_100 border-solid font-normal not-italic xl:pb-[12px] 3xl:pb-[16px] pb-[18.545px] lg:pl-[18px] xl:pl-[21px] 2xl:pl-[24px] 3xl:pl-[28px] pl-[32px] lg:pr-[57px] xl:pr-[65px] 2xl:pr-[73px] 3xl:pr-[88px] pr-[97.999998px] xl:pt-[11px] 3xl:pt-[15px] pt-[17.545px] lg:py-[10px] 2xl:py-[13px] lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_500 text-left w-[100%]"
                    ...
                    <Column className="items-start w-[100%]">
                      ...
                      <div className="2xl:mt-[12px] 3xl:mt-[14px] bg-transparent lg:mt-[9px] mt-[16px] w-[100%] xl:mt-[10px] input-wrap">
                        <Image
                          ...
                          className="absolute right-[39.05005px] bg-transparent lg:right-[22px] xl:right-[26px] 2xl:right-[29px] 3xl:right-[35px] my-[auto] inset-y-[0]"
                          alt="Vector"
                        />
                        <SelectBox
                          className="bg-transparent border border-bluegray_100 border-solid font-normal not-italic xl:pb-[12px] 3xl:pb-[16px] pb-[18.545px] lg:pl-[18px] xl:pl-[21px] 2xl:pl-[24px] 3xl:pl-[28px] pl-[32px] lg:pr-[57px] xl:pr-[65px] 2xl:pr-[73px] 3xl:pr-[88px] pr-[98.00005px] xl:pt-[11px] 3xl:pt-[15px] pt-[17.545px] lg:py-[10px] 2xl:py-[13px] lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_500 text-left w-[100%]"
                          placeholderClassName="bg-transparent text-gray_500"
                          name="Group93"
